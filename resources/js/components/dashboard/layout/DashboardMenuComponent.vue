        ...
        >
            ...
            <li class="nav-item">
                <a @click="integracion()"
                    ...
                    ><span class="menu-title" data-i18n="Integrations"
                        >Integrations</span
                    ></a
                >
            </li>
            ...
            <li class="nav-item">
                <a @click="upgrade()"
                    ...
                    ><span class="menu-title" data-i18n="upgrade"
                        >Subscriptions</span
                    ></a
                >
            </li>
            ...
            <li class="nav-item">
                <a @click="change()"
                    ...
                    ><span class="menu-title" data-i18n="changelog"
                        >Changelog</span
                    ></a
                >
            </li>
            ...
            <li class="nav-item">
                <a @click="soporte()"
                    ...
                    ><span class="menu-title" data-i18n="Support"
                        >Support</span
                    ></a
                >
            </li>
...
export default {
    methods: {
        ...
        change() {
            this.$store.dispatch("setpaginas", "change");
        },
        soporte() {
            this.$store.dispatch("setpaginas", "soporte");
        },
        documentation() {
            this.$store.dispatch("setpaginas", "doc");
        },
        logout() {
