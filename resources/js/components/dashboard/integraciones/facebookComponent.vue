    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                    ...
                    <b-card-group deck>
                        <b-card header-tag="header" footer-tag="footer">
                            <template v-slot:header>
                                <h6 class="mb-0">
                                    <div>An easier way to message.</div>
                                </h6>
                                <div class="col-1">
                                    <b-form-checkbox
                                        align="right"
                            ...
                            <b-card-text>
                                <div class="description">
                                    <p>
                                        Create and teach a conversational bot
                                        for Facebook Messenger.
                                    </p>
                                    <p>
                                        After you design and test your
                                        Dialogflow agent, you can launch your
                                        Messenger bot
                                    </p>
                                    <ol>
                                        <li>
                                            Get your Facebook Page Access Token
                                            and insert it in the field below.
                                        </li>
                                        <li>
                                            Create your own Verify Token (can be
                                            any string).
                                        </li>
                                        <li>Click 'START' below.</li>
                                        <li>
                                            Use the Callback URL and Verify
                                            Token to create an event in the
                ...
                <div>
                    <b-button block variant="primary" @click="back()"
                        >Back</b-button
                    >
                </div>
            </div>
