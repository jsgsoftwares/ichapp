                    ...
                    <b-card-group deck>
                        <b-card header-tag="header" footer-tag="footer">
                            <template v-slot:header>
                                <h6 class="mb-0">
                                    <div>A new era of messaging.</div>
                                </h6>
                                <div class="col-1">
                                    <b-form-checkbox
                                        align="right"
                            ...
                            <b-card-text>
                                <div class="description">
                                    <p>
                                        When your Dialogflow agent is ready,
                                        follow these instructions to connect it
                                        to your Telegram bot:
                                    </p>
                                    <ul>
                                        <li>
                                            Get a Telegram access token from
                                            BotFather and insert it in the
