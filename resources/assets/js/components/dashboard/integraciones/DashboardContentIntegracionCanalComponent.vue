    ...
    <div class="card">
      <div class="card-header mx-auto" v-if="canal == 3">
        <div class="avatar avatar-xl">
          <img class="img-fluid" :src="avatar" alt="img placeholder" v-bind:style="gray" />
        </div>
      ...
      <div class="card-content">
        <div class="card-body text-center">
          ...
          <div class="card-btns d-flex justify-content-between">
            <button class="btn " v-bind:style="botongray" @click="modal(name, canal)" style>
              {{botonConect}}
            </button>
          </div>
          <hr class="my-1" />
           ...
           if(this.subscription.length>0){
            ...
            this.subscription.map((res) => {
                ...
                */
                ...
                if (res.product_id== 2 && res.enabled==1 && this.canal==7) {
                ...
                if (res.product_id== 3 && res.enabled==1  && this.canal==3) {
                  this.gray=  'filter: grayscale(0)';
                  this.botonConect="Connect";
                  this.botongray='background-color:green; color:white;';
                    //this.state.whatsappactive = true;
                } 
                if (res.product_id== 4 && res.enabled==1 && this.canal==2) {
                    this.gray=  'filter: grayscale(0)';
                    this.botonConect="Connect";
                    this.botongray='background-color:green; color:white;';
                } 
                if (res.product_id== 5 && res.enabled==1  && this.canal==4) {
                   this.gray=  'filter: grayscale(0)';
                   this.botonConect="Connect";
                   this.botongray='background-color:green; color:white;';
                } 
