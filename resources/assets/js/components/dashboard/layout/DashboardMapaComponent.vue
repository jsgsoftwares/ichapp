              ...
              <div class="card-body">
                <div class="d-flex">
                  <p class="d-flex flex-column">
                    <span class="text-bold text-lg">{{totmensajes}}</span>
...
export default {
  ...
  mounted() {
    this.$store.dispatch('getDashboardmensajes').then(()=>{
      ...
      this.inicio();
        ...
        methods:{
            ...
            inicio()
            {
              ...
              for (var i = 1; i <this.datos.length ; i++) {
                   ...
                   this.totmensajes+=this.datos[i][j];
        ...
        computed:
        {
            datos()
            {
                return this.$store.state.DashMensajes;
            }
        }
